<div >
    ...
    <?php endif; ?>
    <img src="svg/back-<?php echo e($bg); ?>.svg" class="back" />
        <div class="container-fluid backstg" style="background-image: url('img/new_background.jpg')">
            <div class="col-sm-12">
                <img src="svg/icicle-<?php echo e($color); ?>.svg" class="icicle">
                <h1 class="jumbtext" style="color: #<?php echo e($color); ?>"> Coldman</h1>
                <img src="svg/water-<?php echo e($color); ?>.svg" class="water-1">
                <img src="svg/water-<?php echo e($color); ?>.svg" class="water-2">
                <img src="svg/water-<?php echo e($color); ?>.svg" class="water-3">
            </div>
        </div>

        <div class="container-fluid" style="background-color:#<?php echo e($bg); ?> !important">
            <br>
        <div class="col-sm">
        <h4 style="color: #<?php echo e($color); ?>;position:relative" class="text">Munkatársaink 20 éves tapasztalattal,valamint a legkorszerűbb
                 eszközök használatával segítenek megvalósítani ügyfeleink minden klímával kapcsolatos igényét.</h4>
         <br>
        </div>
        </div>
        <img src="svg/cloud-<?php echo e($bg); ?>.svg"  />
        ...
        <div class="col-sm-12">
                <?php $__currentLoopData = $airconditioners->chunk(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $air_ch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="row">
                 <?php $__currentLoopData = $air_ch; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $airconditioner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-sm-8 col-md-4 align-self-center" style="padding-top: 10px">
                        <img src="svg/icicle.svg"  class="thumb_icicle" />
                       <div class="img-thumbnail">
                          <img src="img/<?php echo e($airconditioner->image); ?>" class="rounded mx-auto d-block air_image" >
                           <div class="caption" >
                             <h3><?php echo e($airconditioner->name); ?> </h3>
                             <h5 style="padding-top: 5px">Előnyök: </h5>
                             <ul>
                             <?php $__currentLoopData = explode(',',$airconditioner->description); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li style="font-weight: 500"><?php echo e($item); ?></li>
                             <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                             </ul>
                             <div class="row">
                                 <div class="col-sm-6"><img src="svg/cold.svg" height="30px"/> <span class="tum_text"><?php echo e($airconditioner->coldclass); ?> </span></div>
                                 <div class="col-sm-6"><img src="svg/hot.svg" height="30px"/> <span class="tum_text"><?php echo e($airconditioner->hotclass); ?></div>
                             </div>
                             <br>
                             <div class="row">
                                <div class="col-sm-6"><img src="svg/coldenergy.svg" height="30px"/> <span class="tum_text"><?php echo e($airconditioner->coldperfomance); ?> </span></div>
                                <div class="col-sm-6"><img src="svg/hotenergy.svg" height="30px"/> <span class="tum_text"><?php echo e($airconditioner->hotperfomance); ?></div>
                            </div>
                           </div>
                      </div>
                    </div>
...
<?php /**PATH C:\xampp\htdocs\ColdmanEles\resources\views/components/main.blade.php ENDPATH**/ ?>